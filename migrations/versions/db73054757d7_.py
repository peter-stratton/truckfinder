...
Revision ID: db73054757d7
Revises: 
Create Date: 2017-05-21 13:10:05.516259
...
def upgrade():
    ...
    sa.Column('engine_27L_count', sa.Integer(), nullable=True),
    sa.Column('engine_35L_count', sa.Integer(), nullable=True),
    sa.Column('avg_msrp', sa.Integer(), nullable=True),
    sa.Column('avg_allx', sa.Integer(), nullable=True),
    sa.Column('avg_az', sa.Integer(), nullable=True),
    ...
    sa.Column('f_bodycolor', sa.String(length=256), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('date', sa.DateTime(), nullable=True),
    sa.Column('dealer_price', sa.Integer(), nullable=True),
